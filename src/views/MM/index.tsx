...
function PostBox({ unShow }: PostBoxProps) {
    ...
    // function: psot tool response 처리 함수 //
    const postToolResposne = (responseBody: ResponseDto | null) => {
        const message =
    ...
    // event hadnler: 등록 버튼 클릭 이벤트 처리 함수 //
    const onPostButtonClickHandler = () => {
        ...
        postToolRequest(requestBody, accessToken).then(postToolResposne);
    };
